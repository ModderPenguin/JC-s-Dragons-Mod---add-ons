...
public class BlockMysticLeaves extends BlockLeavesBase implements IShearable
{
    ...
    public BlockMysticLeaves(int par1)
    {
    ...
    {
        return MTNSBase.mysticSapling.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(MTNSBase.appleMystic, 1, 0));
            }
        }
    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("MTNS:MysticLeaves");
    }
