...
public class ItemMTNSTool extends Item
{
    ...
    protected EnumMTNSToolMaterial toolMaterial;

    protected ItemMTNSTool(int par1, int par2, EnumMTNSToolMaterial par3EnumToolMaterial, Block[] par4ArrayOfBlock)
    {
        super(par1);
