...
public class ItemMTNSHoe extends Item
{
    protected EnumMTNSToolMaterial theToolMaterial;

    public ItemMTNSHoe(int par1, EnumMTNSToolMaterial par2EnumToolMaterial)
    {
        super(par1);
