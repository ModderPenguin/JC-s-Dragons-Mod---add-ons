...
public class EntityGrenny extends EntityTameable
{
    ...
    public EntityGrenny(World par1World)
    {
        super(par1World);
        this.texture = "/mods/jcdragons/textures/mob/Grenny.png";
    ...
    {
        return this.isTamed() ? "/mods/jcdragons/textures/mob/Grenny_Tamed.png" : (this.isAngry() ? "/mods/jcdragons/textures/mob/Grenny_Angry.png" : super.getTexture());
    }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else if (itemstack != null && itemstack.itemID == Item.melon.itemID && !this.isAngry())
        {
            if (!par1EntityPlayer.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
     ...
     */
    public EntityGrenny spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityGrenny entitywolf = new EntityGrenny(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityGrenny))
        {
            return false;
        }
        else
        {
            EntityGrenny entitywolf = (EntityGrenny)par1EntityAnimal;
