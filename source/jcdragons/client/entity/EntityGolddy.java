...
public class EntityGolddy extends EntityTameable
{
    ...
    public EntityGolddy(World par1World)
    {
        super(par1World);
        this.texture = "/mods/jcdragons/textures/mob/Golddy.png";
    ...
    {
        return this.isTamed() ? "/mods/jcdragons/textures/mob/Golddy_Tamed.png" : (this.isAngry() ? "/mods/jcdragons/textures/mob/Golddy_Angry.png" : super.getTexture());
    }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else if (itemstack != null && itemstack.itemID == Item.ingotGold.itemID && !this.isAngry())
        {
            if (!par1EntityPlayer.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
     ...
     */
    public EntityGolddy spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityGolddy entitywolf = new EntityGolddy(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityGolddy))
        {
            return false;
        }
        else
        {
            EntityGolddy entitywolf = (EntityGolddy)par1EntityAnimal;
