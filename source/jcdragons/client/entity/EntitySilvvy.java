...
public class EntitySilvvy extends EntityTameable
{
    ...
    {
        super(par1World);
        this.texture = "/mods/jcdragons/textures/mob/Silvvy.png";
    ...
    {
        return this.isTamed() ? "/mods/jcdragons/textures/mob/Silvvy_Tamed.png" : (this.isAngry() ? "/mods/jcdragons/textures/mob/Silvvy_Angry.png" : super.getTexture());
    }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else if (itemstack != null && itemstack.itemID == Item.cookie.itemID && !this.isAngry())
        {
            if (!par1EntityPlayer.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
     ...
     */
    public EntitySilvvy spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntitySilvvy entitywolf = new EntitySilvvy(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntitySilvvy))
        {
            return false;
        }
        else
        {
            EntitySilvvy entitywolf = (EntitySilvvy)par1EntityAnimal;
