package jcdragons.client.entity;
...
public class EntityEbby extends EntityTameable
{
    ...
    public EntityEbby(World par1World)
    {
        super(par1World);
        this.texture = "/mods/jcdragons/textures/mob/Ebby.png";
        ...
        this.targetTasks.addTask(4, new EntityAITargetNonTamed(this, EntitySilvvy.class, 16.0F, 200, false));
    }
    ...
    {
        	return this.isTamed() ? "/mods/jcdragons/textures/mob/Ebby_Tamed.png" : (this.isAngry() ? "/mods/jcdragons/textures/mob/Ebby_Angry.png" : super.getTexture());
    }
    ...
    {
        return this.isAngry() ? "mob.wolf.growl" : (this.rand.nextInt(3) == 0 ? (this.isTamed() && this.dataWatcher.getWatchableObjectInt(18) < 10 ? "mob.wolf.whine" : "mob.wolf.panting") : "DragonBrosMod.mob.dragon_live");
    }
    ...
    {
        return "DragonBrosMod.mob.dragon_live";
    }
    ...
    {
    	this.dropItem(JCDMBase.dragonTear.itemID, 1);
    }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else if (itemstack != null && itemstack.itemID == Item.appleRed.itemID && !this.isAngry())
        {
            if (!par1EntityPlayer.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
     ...
     */
    public EntityEbby spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityEbby entitywolf = new EntityEbby(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityEbby))
        {
            return false;
        }
        else
        {
            EntityEbby entitywolf = (EntityEbby)par1EntityAnimal;
