...
public class ItemDragonTear extends Item {

	public ItemDragonTear(int par1) {
		super(par1);
	...
	{
		 this.iconIndex = iconRegister.registerIcon("jcdragons:DragonTear");
	}
